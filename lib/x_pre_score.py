...
# フックに使える強ワード — 2026-05-10刷新: clickbaitドラマ語を排除
# 「衝撃/緊急/まさか/電撃/神/レベチ/完全/炎上/暴露/騒然/尊い」削除 → algorithm評価で
# X impressionsが1桁になる主因だった
HOOK_STRONG_WORDS = [
    "速報", "決定", "発表", "解禁", "判明", "ついに",
    "初公開", "復活", "即完売", "話題", "確定", "新展開",
    "リリース", "公開", "再結成", "デビュー", "カムバック",
]

# 弱い書き出し（減点対象） — 2026-05-10: 「まとめ/解説/情報」を削除
# これらは事実駆動型templateで使う正規語であり、減点対象ではない
WEAK_OPENINGS = [
